...
<input type="hidden" id="pchap_max" name="pchap_max">
		...
		<div data-role="panel" id="panel">
			<a href="#" data-rel="close" class="ui-btn ui-corner-all ui-icon-delete ui-btn-icon-notext">Menu</a>
			<!--h1>Menu</h1-->
...
?>
		...
		<div data-role="content">
			<audio id="inzoe_audio" class="audio" style="width:95%;" src="" controls autoplay></audio><br>
